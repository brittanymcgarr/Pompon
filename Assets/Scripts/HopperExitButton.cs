////////////////////////////////////////////////////////////////////////////////
// HopperExitButton.cs                                                        //
// Gaze selection for exit button menu item.                                  //
//                                                                            //
// CPE 481 Fall 2016                                                          //
// Brittany McGarr                                                            //
////////////////////////////////////////////////////////////////////////////////
...
public class HopperExitButton : MonoBehaviour, IGvrGazeResponder {
	// Public variables
	...
	private SeedHopper crateScript;
	...
	void Start () {
		...
		crate = GameObject.Find("SeedHopper").gameObject;
		crateScript = crate.GetComponent<SeedHopper>();
	}
	...
	void Update () {
		...
		if(heldTime <= 0.0f) {
			...
			if(crateScript.currentMenu == "") {
				if(crateScript.stage == 'b' || crateScript.stage == 'r') {
					crateScript.nextMenu = "";
					crateScript.currentMenu = "repair";
				} else {
					crateScript.nextMenu = "";
					crateScript.currentMenu = "";
				}
			} else {
				crateScript.nextMenu = "exit";
			}
		}
	}
}
