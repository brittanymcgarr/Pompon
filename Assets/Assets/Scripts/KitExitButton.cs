...
public class KitExitButton : MonoBehaviour, IGvrGazeResponder {
	// Public variables
	...
	private People_Kit crateScript;
	...
	void Start () {
		...
		crate = GameObject.Find("Kit").gameObject;
		crateScript = crate.GetComponent<People_Kit>();
	}
