...
public class People_Kit : MonoBehaviour, IGvrGazeResponder {
	...
	public void MenuControl() {
		if(currentMenu == "animals") {
			...
			menuText.text = "\nDid you want to sell a Chicken?";
			leftText.text = "Chicken";
			rightText.text = "Next";
			...
			if(nextMenu == "exit") {
				...
				currentMenu = "sellAnimal2";
				nextMenu = "";
			} else {
			
			}
		} else if(currentMenu == "sellAnimal2") {
			menuText.text = "\nDid you want to sell a Cow?";
			leftText.text = "Cow";
			rightText.text = "Next";
			...
			if(nextMenu == "exit") {
				...
				currentMenu = "sellAnimal3";
				nextMenu = "";
			} else {
			
			}
		} else if(currentMenu == "sellAnimal3") {
			menuText.text = "\nDid you want to sell a Bunny?";
			leftText.text = "Bunny";
			rightText.text = "Back";
		...
		} else if(currentMenu == "sellBunny") {
			while(animalChoice < 6 && GameControl.control.bunnies[animalChoice][8] == '0') {
				animalChoice += 1;
			}
			
			int alleleA, alleleB, dominant, price = 0;
			string menuSpeech = "\nI can buy the " + animals[animalChoice];
			
			if(animalChoice < 6) {
				alleleA = GameControl.control.bunnies[animalChoice][8] - '0';
				alleleB = GameControl.control.bunnies[animalChoice][10] - '0';
				...
				if(dominant == 1) {
					menuSpeech = menuSpeech + " white rabbit for 1500g";
					price = 1500;
				} else if(dominant == 2) {
					menuSpeech = menuSpeech + " gray rabbit for 1000g";
					price = 1000;
				} else if(dominant == 3) {
					menuSpeech = menuSpeech + " black rabbit for 750g";
					price = 750;
				} else {
					menuSpeech = menuSpeech + " brown rabbit for 500g";
					price = 500;
				}
				
				menuText.text = menuSpeech;
				leftText.text = "Sure!";
			...
			if(nextMenu == "exit") {
				currentMenu = "";
				nextMenu = "";
			} else if(nextMenu == "left" && animalChoice < 6) {
				currentMenu = "success";
				nextMenu = "";
				...
				string bunnyTime = nowTime.ToString(datetimeFormat);
				
				GameControl.control.bunnies[animalChoice] = "Bunny0" + (char)(animalChoice + 48) + ",0,0,N," + bunnyTime;
