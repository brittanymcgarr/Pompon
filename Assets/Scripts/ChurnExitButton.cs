...
public class ChurnExitButton : MonoBehaviour, IGvrGazeResponder {
	// Private variables
	private float timeToHold = 1.5f;
	private float heldTime;
	private bool gazeIn = false;
	private GameObject crate;
	private Churn crateScript;
	...
	void Start () {
		...
		crate = GameObject.Find("Churn").gameObject;
		crateScript = crate.GetComponent<Churn>();
	}
